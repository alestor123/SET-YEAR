...
module.exports = (username, year, branch, repo) => {
  ...
  return execSync('git init && git add . &&' + ' GIT_COMMITTER_DATE="' + time + '" git commit -m "' + year + '" --no-edit --date "' + time + '"' + ' && git push -u ' + 'https://github.com/' + username + '/' + (repo || year) + '.git ' + (branch || 'main')).toString()
}
